  ...
  <section class="my-30">
    <div class="container mx-auto flex justify-between gap-10">
      ...
      <div class="flex max-w-3xl flex-col justify-center gap-4">
        ...
        <ul
          class="list-image-[url(/logo/check-mark.png)] text-lg list-inside font-semibold leading-10"
        >
          <li>Akreditasi A</li>
    ...
    <div class="container mx-auto">
      <div class="flex justify-between gap-10">
        ...
        <div class="w-full">
          ...
          <ul
            class="list-image-[url(/logo/check-mark.png)] text-lg list-inside leading-10"
          >
